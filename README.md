...
L’objectif est de construire un dashboard interactif permettant de suivre la performance commerciale, d’identifier les clients à forte valeur et de aprioriser les actions marketing grâce à la segmentation RFM.
